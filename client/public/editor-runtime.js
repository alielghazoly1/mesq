...
(function () {
  ...
  function isColorSwatch(el) {
    // العنصر نفسه صورة/رسمة/فيديو/فريم؟ مش مربع لون أبدًا. مهم جدًا لما
    // الـ data-elem-id بيتحط على <img> مباشرة (زي قالب Ivory Swans) —
    // من غير السطر ده الصورة كانت بتتحسب "مربع لون" فيطلع منتقي لون بدل
    // زرار تغيير الصورة، والعميل مش قادر يبدّل الصورة.
    if (/^(IMG|SVG|VIDEO|IFRAME|PICTURE|CANVAS)$/.test(el.tagName)) return false;
